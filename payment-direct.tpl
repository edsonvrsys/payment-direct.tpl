...
;(function(win, doc, $, undefined) {
    ...
    ;(function masksInputs() {
        ...
        $('.cpf-cnpj-mask').on('keyup', function() {
            ...
            //9 is number optional, is fake the transition two types mask
    ...
    $('#payment-boleto').on('click', function(e){
        ...
        var query = $.ajax({
            ...
            success: function(response) {
                ...
                if (result.success) {
                    $('form#billet-form #payment_url').attr('value', result.payload.data.payment_link);
                    $('form#billet-form').submit();

                    // var form = $('<form>', {
                    //     'action': 'http://10.1.1.10/servicos/prestashop/lavpecas/index.php?fc=module&module=pagseguro&controller=success',
                    //     'method': 'post'
                    // })
                    // .append(
                    //     $('<input>', {
    ...
    $('#payment-debit').on('click', function(e){
        ...
        var query = $.ajax({
            ...
            success: function(response) {
                var result = $.parseJSON(response);
                if (result.success) {
                    $('form#debit-form #payment_url').attr('value', result.payload.data.payment_link);
                    $('form#debit-form').submit();
                    // var form = $('<form>', {
